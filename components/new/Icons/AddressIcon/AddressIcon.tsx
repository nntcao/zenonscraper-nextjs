...
export default function AddressIcon(props) {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <filter id="filter0_d_670_36" x="-1" y="-1" width="27" height="26" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    ...
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_670_36" />
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_670_36" result="shape" />
                </filter>
