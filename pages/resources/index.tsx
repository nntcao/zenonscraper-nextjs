...
function OfficialZenon() {
    return (
        <div className={styles.card}>
            <h1 className={styles.subtitle}>Official Zenon Network</h1>
            <hr/>
...
function ZenonCommunity() {
    return (
        <div className={styles.card}>
            <h1 className={styles.subtitle}>Zenon Community</h1>
            <hr/>
            <ul className={styles.linksList}>
...
function DevLinks() {
    return (
        <div className={styles.card}>
            <h1 className={styles.subtitle}>Useful Tools/Links</h1>
            <hr/>
            <ul className={styles.linksList}>
